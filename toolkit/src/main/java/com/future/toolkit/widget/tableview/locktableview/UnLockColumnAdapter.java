...
public class UnLockColumnAdapter extends RecyclerView.Adapter<UnLockColumnAdapter.UnLockViewHolder> {
    ...
    public void onBindViewHolder(UnLockViewHolder holder, final int position) {
        ...
        //设置内容背景
        if (position %2 == 0) {
            holder.mLinearLayout.setBackgroundColor(ContextCompat.getColor(mContext, R.color.table_content));
        }
...
//                } else {
//                    splitView.setBackgroundColor(ContextCompat.ContextCompat.getColor(mContext, R.color.light_gray));
//                }
