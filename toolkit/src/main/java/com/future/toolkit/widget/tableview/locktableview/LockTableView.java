package com.future.toolkit.widget.tableview.locktableview;
...
import com.future.toolkit.widget.tableview.xrecyclerview.ProgressStyle;
import com.future.toolkit.widget.tableview.xrecyclerview.XRecyclerView;
...
//            Log.e("每行数据", mTableRowDatas.toString());
    ...
    private void initView() {
        ...
        mTableScrollView.isEnableRefresh(isEnableRefresh);
...
//                }
                splitView.setBackgroundColor(ContextCompat.getColor(mContext, R.color.dividing_line));
    ...
    public LockTableView isEnableRefresh(boolean isEnable) {
