package com.future.toolkit.widget.tableview.xrecyclerview;
...
public class XRecyclerView extends RecyclerView {
    ...
    private boolean pullRefreshEnabled = true; //为false会抛空指针异常 ,修改异常问题的话就不灵活了
    ...
    public void isEnableRefresh(boolean isEnable) {
